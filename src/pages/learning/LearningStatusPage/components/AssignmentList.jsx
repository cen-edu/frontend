import { formatDateTime, getDueStatus, learningTypeLabels } from '../learningStatusUtils';
        ...
        <section className="learning-panel learning-assignments" aria-labelledby="assignment-list-title">
            ...
            <div className="learning-assignments__list">
                {assignments.map((assignment) => {
                    ...
                    const rate = assignment.studentCount > 0
                        ? Math.round((submitted / assignment.studentCount) * 100)
                        : 0;
                    ...
                    return (
                        <button
                            ...
                            type="button"
                            className={`learning-assignments__item${String(selectedId) === String(assignment.assignmentId) ? ' learning-assignments__item--active' : ''}`}
                            aria-pressed={String(selectedId) === String(assignment.assignmentId)}
                            onClick={() => onSelect(String(assignment.assignmentId))}
                        >
                            ...
                            <span className="learning-assignments__due">
                                <span><i className="bi bi-calendar3" aria-hidden="true" /> 마감 {formatDateTime(assignment.dueAt)}</span>
                            ...
                            <span className="learning-assignments__progress">
                                <span><b>제출 {submitted}/{assignment.studentCount}명</b><em>{rate}%</em></span>

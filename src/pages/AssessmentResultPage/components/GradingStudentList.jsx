function GradingStudentList({ students, selectedId, onSelect }) {
    const completedCount = students.filter((student) => student.answers.every((answer) => answer.score !== null)).length;
        ...
        <aside className="grading-student-list" aria-label="학생 목록">
            ...
            <div className="grading-student-list__items">
                {students.map((student) => {
                    const complete = student.answers.every((answer) => answer.score !== null);

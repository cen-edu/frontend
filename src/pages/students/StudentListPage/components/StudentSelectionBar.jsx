function StudentSelectionBar({ selectedCount, onDelete = () => {}, onClear, deleteDisabled = false }) {
    ...
    return (
        <div className="student-list__selection-bar" role="region" aria-label="선택 학생 관리">
            ...
            <div className="student-list__selection-actions">
                <button type="button" className="student-list__selection-delete" disabled={deleteDisabled} onClick={onDelete}>

...
function WrongAnswerPage() {
    ...
    const filteredWorksheets = useMemo(() => worksheets.filter((worksheet) =>
        ...
        && (!search.trim() || worksheet.title.toLowerCase().includes(search.trim().toLowerCase()))), [classId, customEndDate, customStartDate, gradeId, period, search, status, worksheets]);

...
const linearEquationStudents = [
    { id: 101, name: '김민서', score: 42, accuracy: 42, submittedAt: '오늘 09:12', status: 'graded', weakConcept: '일차방정식의 활용' },
    { id: 102, name: '박준호', score: 48, accuracy: 48, submittedAt: '오늘 09:25', status: 'graded', weakConcept: '등식의 성질' },
    { id: 103, name: '이서윤', score: 55, accuracy: 55, submittedAt: '어제 16:40', status: 'graded', weakConcept: '일차방정식의 풀이' },
    { id: 104, name: '최지우', score: 61, accuracy: 61, submittedAt: '오늘 10:08', status: 'graded', weakConcept: '일차방정식의 활용' },
    { id: 105, name: '정도윤', score: 66, accuracy: 66, submittedAt: '오늘 09:48', status: 'graded', weakConcept: '등식의 성질' },
    { id: 106, name: '한예린', score: 72, accuracy: 72, submittedAt: '어제 17:05', status: 'graded', weakConcept: '식의 계산' },
    { id: 107, name: '윤하준', score: 76, accuracy: 76, submittedAt: '오늘 10:17', status: 'graded', weakConcept: '식의 계산' },
    { id: 108, name: '오서아', score: 81, accuracy: 81, submittedAt: '오늘 09:31', status: 'graded', weakConcept: '등식의 성질' },
    { id: 109, name: '강시우', score: 86, accuracy: 86, submittedAt: '어제 15:22', status: 'graded', weakConcept: '일차방정식의 풀이' },
    { id: 110, name: '송채원', score: 92, accuracy: 92, submittedAt: '오늘 10:02', status: 'graded', weakConcept: '없음' },
    { id: 111, name: '임도현', score: 44, accuracy: 44, submittedAt: '오늘 09:18', status: 'graded', weakConcept: '일차방정식의 활용' },
    { id: 112, name: '백수빈', score: 53, accuracy: 53, submittedAt: '어제 16:18', status: 'graded', weakConcept: '등식의 성질' },
    { id: 113, name: '조현우', score: 59, accuracy: 59, submittedAt: '오늘 09:56', status: 'graded', weakConcept: '일차방정식의 풀이' },
    { id: 114, name: '신유진', score: 64, accuracy: 64, submittedAt: '오늘 10:21', status: 'graded', weakConcept: '일차방정식의 활용' },
    { id: 115, name: '문지호', score: 69, accuracy: 69, submittedAt: '어제 17:14', status: 'graded', weakConcept: '등식의 성질' },
    { id: 116, name: '안서진', score: 74, accuracy: 74, submittedAt: '오늘 09:43', status: 'graded', weakConcept: '식의 계산' },
    { id: 117, name: '유건우', score: 79, accuracy: 79, submittedAt: '오늘 10:11', status: 'graded', weakConcept: '일차방정식의 풀이' },
    { id: 118, name: '장하은', score: 88, accuracy: 88, submittedAt: '어제 16:52', status: 'graded', weakConcept: '없음' },
];

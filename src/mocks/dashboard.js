...
const sharedActivities = [
    ...
    { id: 4, title: '박준호 학생이 맞춤 문제를 완료했습니다.', time: '어제', icon: 'bi-check-circle-fill', tone: 'green', path: '/learning' },
];
...
const dashboardData = {
    ...
    'middle-1-2': {
        ...
        activities: [
            ...
            { id: 8, title: '송채원 학생이 맞춤 문제를 완료했습니다.', time: '어제', icon: 'bi-check-circle-fill', tone: 'green', path: '/learning' },
        ],

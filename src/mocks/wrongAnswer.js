...
export const wrongAnswerWorksheets = [
    {
        id: 'factor-assessment', classId: 'class-1', period: 'this-week', type: 'assessment', title: '2단원 소인수분해 종합평가', className: '중학교 1학년 3반', assignStatus: 'none',
        wrongItems: [
    ...
    {
        id: 'factor-practice', classId: 'class-1', period: 'this-week', type: 'practice', title: '2단원 소인수분해 연습', className: '중학교 1학년 3반', assignStatus: 'reviewing',
        wrongItems: [
    ...
    {
        id: 'factor-custom', classId: 'class-1', period: 'this-month', type: 'practice', title: '공통소인수 맞춤 학습', className: '중학교 1학년 3반', assignStatus: 'done',
        wrongItems: [
